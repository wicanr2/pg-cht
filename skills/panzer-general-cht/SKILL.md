...
**AG 已知未翻譯**:戰役選單地名(39 條 Table A/B/C 中的 Sidi Barrani / El Alamein / Anzio / Berlin 等)。詳見下方 AG 戰役選單章節。
...
|---|---|---|---|---|
| Table A | `0x1C2800-0x1C29E8` (39 entries) | **未用(顯示+lookup 都不是)** | `0x956BB` ref @ `0x956E3` | 0-7(只用前 😎 |
